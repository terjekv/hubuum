...
urlpatterns = [
    ...
    path("user/<key>", views.UserDetail.as_view()),
    path("groups/", views.GroupList.as_view()),
    path("group/<key>", views.GroupDetail.as_view()),
    #    path('api-auth/', include('rest_framework.urls', namespace='rest_framework')),
    #    path('token-auth/', tokens.ObtainExpiringAuthToken.as_view()),
    path("permissions/", views.Permission.as_view()),
    path(
        "permission/<key>", views.PermissionDetail.as_view(), name="permission-detail"
    ),
    path("namespaces/", views.NamespaceList.as_view()),
    path("namespace/<key>", views.Namespace.as_view(), name="namespace-detail"),
    path("hosts/", views.HostList.as_view()),
    path("host/<key>", views.Host.as_view(), name="host-detail"),
