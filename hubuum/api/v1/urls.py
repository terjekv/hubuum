...
#    path('api/v1/token-auth/', tokens.ObtainExpiringAuthToken.as_view()),
    ...
    path('api/v1/po/<int:pk>', views.PurchaseDocument.as_view(), name="purchaseorder-detail"),

    path('api/v1/purchasedocuments', views.PurchaseDocumentList.as_view()),
    path('api/v1/purchasedocument/<int:pk>', views.PurchaseDocument.as_view(), name="purchasedocument-detail"),
